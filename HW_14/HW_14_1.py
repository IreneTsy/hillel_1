...
class Chessboard:
        ...
        def __init__(self):
            ...
            # Створюємо клас шахова дошка і розміщаємо всередині квадрати
            # двох видів
            self.board = [
                    ['░', '█', '░', '█', '░', '█', '░', '█'],
                    ['█', '░', '█', '░', '█', '░', '█', '░'],
        ...
        def random_placement(self):
            ...
            # Перемішуємо всі фігури, формуємо вибірку та обов'язково
            # додаємо двох королів
            h = random.randint(1, len(self.p))
            random_pieces = random.choices(self.p, k=h)
            self.pieces = random_pieces + self.kings

            # Запускаємо цикл,який буде додавати по одній фігурі зі списку
            #  у випадкову ячейку, значення якої задано умовою
        ...
        def print_board(self):
            # Друкуємо карскас дошки та саму дошку построчно
